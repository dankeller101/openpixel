// Fluence Pixel v1.0.0 | Published By Fluence
...
Cookie.setUtms(); // save fluenceId if it exists

Cookie.setFluenceId(); // process the queue and future incoming commands
...
window.onload = function () {
  ...
  var dataAttributes = document.querySelectorAll('[data-fluence-event]');

  for (var i = 0, l = dataAttributes.length; i < l; i++) {
    dataAttributes[i].addEventListener('click', function (_e) {
      var event = this.getAttribute('data-fluence-event');
